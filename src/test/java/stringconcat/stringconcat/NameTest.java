...
class NameTest {
    ...
    @Test
    void invalidParametersShouldThrowExceptionNullFamilyName() throws IllegalArgumentException {
    ...
    @Test
    void invalidParametersShouldThrowExceptionNullGivenName() throws IllegalArgumentException {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> new Name("Smith", "G", null, Title.MR));
        assertEquals("Family name and given name must not be empty!", ex.getMessage());
    }

    @Test
    void invalidParametersShouldThrowExceptionEmptyFamilyName() throws IllegalArgumentException {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> new Name("", "G", "John", Title.MR));
        assertEquals("Family name and given name must not be empty!", ex.getMessage());
    }

    @Test
    void invalidParametersShouldThrowExceptionEmptyGivenName() throws IllegalArgumentException {
